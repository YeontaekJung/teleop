...
class Rby1Ik:
    ...
    def _init_pink(self, urdf_path: str, srdf_path: str):
        ...
        # Tasks
        self._task_left  = FrameTask('tracker_left',  position_cost=50.0, orientation_cost=2.0)
        self._task_right = FrameTask('tracker_right', position_cost=50.0, orientation_cost=2.0)
